...
__global__ void max_probability_before(int *n_states,
...
//        printf(" T%d: \n", i);
        ...
        max_probability_before << < n_states, THREADS_PER_BLOCK,
...
//            printf("bidx:%d, tran[%d]:%.4e \n", bidx, j, dev_tran_matrix[j]);
